  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
    ...
    function dvA0(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(router, alert, http) {
        ...
        _createClass(LoginComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {} // 로그인

        }, {
          key: "login",
          value: function login() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var _yield$this$http$post, token, data;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return this.http.post('/rpc/login', this.user);

                    case 3:
                      _yield$this$http$post = _context.sent;
                      token = _yield$this$http$post.token;
                      data = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_2__["default"])(token);
                      ...
                      localStorage.setItem('user_id', data.user_id); // localStorage.setItem('logo', data.company_logo_url);
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 25,
        vars: 5,
        consts: [[1, "account-pages", "my-5", "pt-sm-5"], [1, "container"], [1, "row", "justify-content-center"], [1, "col-md-8", "col-lg-6", "col-xl-5"], [1, "card", "overflow-hidden"], [1, "card-body"], [1, "logo"], ["src", "assets/imgs/logo.png", "alt", ""], [1, "input-item", "mb-16"], ["type", "email", "id", "email", "placeholder", "\uC544\uC774\uB514\uB97C \uC785\uB825\uD558\uC138\uC694.", "name", "email", 3, "ngModel", "ngModelChange"], [1, "input-item"], ["type", "password", "placeholder", "\uBE44\uBC00\uBC88\uD638\uB97C \uC785\uB825\uD574\uC8FC\uC138\uC694.", 3, "ngModel", "ngModelChange", "keyup.enter"], [1, "check-wrap"], [1, "custom-control", "custom-checkbox"], ["type", "checkbox", "id", "all", 1, "custom-control-input", 3, "ngModel", "ngModelChange"], ["for", "all", 1, "custom-control-label"], ["type", "checkbox", "id", "login", 1, "custom-control-input", 3, "ngModel", "ngModelChange"], ["for", "login", 1, "custom-control-label"], [1, "login-btn", 3, "disabled", "click"]],
